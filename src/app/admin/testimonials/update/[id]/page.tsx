...
import UpdateTestimonialsForm from "@/app/components/testimonials/updateTestimonialsForm";

const prisma = new PrismaClient();

export default async function TestimonialUpdatePage({ params }: { params: Promise <{ id: string }> }) {
  try {
    ...
    if (!testimonial) return <p className="text-red-500 text-center">Certificate Detail not found</p>;

    return <UpdateTestimonialsForm testimonial ={testimonial} />;
